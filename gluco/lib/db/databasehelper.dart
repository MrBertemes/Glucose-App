  ...
  Future _onCreate(Database db, int version) async {
    ...
    await db.execute('''
      CREATE TABLE measurementscoll (
        ...
        maxled_1 REAL NOT NULL,
        maxled_2 REAL NOT NULL,
        maxled_3 REAL NOT NULL,
        maxled_4 REAL NOT NULL,
        minled_1 REAL NOT NULL,
        minled_2 REAL NOT NULL,
        minled_3 REAL NOT NULL,
        minled_4 REAL NOT NULL,
        m1_4p REAL NOT NULL,
        m2_4p REAL NOT NULL,
        m3_4p REAL NOT NULL,
        m4_4p REAL NOT NULL,
